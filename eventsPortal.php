	...
	public function databaseStructure ()
	{
		return "
			CREATE TABLE IF NOT EXISTS `{$this->settings['administrators']}` (
			  `username` varchar(" . ($this->settings['internalAuth'] ? '191' : '10') . ") COLLATE utf8mb4_unicode_ci NOT NULL,
			...
			CREATE TABLE IF NOT EXISTS `{$this->settings['table']}` (
			  ...
			  `urlSlug` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'URL part',
			  `provider` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Event provider',
			  `organisation` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Organisation',
			  `eventName` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name of event',
			  `description` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Description of event',
			  `locationName` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Where is the event taking place?',
			  ...
			  `picture` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Image',
			  ...
			  `daysOfWeek` set('Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sunday') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'If running over a date range, day(s) of week',
			  `otherDates` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Does this event run on to any other dates? Please give details if so.',
			  `recurrence` enum('Just this day/time','Event recurs at the same day/time each week during full term','Event recurs at the same day/time each week during the whole year') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Just this day/time' COMMENT 'Does the event recur each week?',
			  `eligibility` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Who can attend?',
			  `deleted` int(1) DEFAULT NULL COMMENT 'Event has been deleted?',
			  `user` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Added/updated by user',
			  ...
			  `cost` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Cost to attend',
			  `contactInfo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Contact info (if not main organisation details)',
			  `webpageUrl` text COLLATE utf8mb4_unicode_ci COMMENT 'URL of webpage about the event (if any)',
			  `facebookUrl` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Facebook URL about the event (if any)',
			...
			CREATE TABLE IF NOT EXISTS `{$this->settings['settingsTable']}` (
			  ...
			  `feedbackRecipient` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'E-mail of feedback recipient',
			  `applicationName` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Events' COMMENT 'Brand name of the application',
			  `applicationNameExtended` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Events' COMMENT 'Brand name of the application (extended)',
			  `welcomeTextHtml` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '<strong>Welcome</strong> to our event listings service!' COMMENT 'HTML fragment for welcome text',
			  `notifyOnSubmission` int(1) DEFAULT NULL COMMENT 'Whether to e-mail the feedback recipient when an event is submitted',
			  `eventAppendedHtml` text COLLATE utf8mb4_unicode_ci COMMENT 'Optional HTML appended to event page; %id will be replaced with the event ID if present',
			  `specialNoticeHtml` text COLLATE utf8mb4_unicode_ci COMMENT 'Special notice (as HTML), if required',
			  `whereHappening` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '%s lists events taking place.' COMMENT 'Phrase for where the events are happening (%s becomes application name)',
			  `feedDescriptionDefault` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Events' COMMENT 'Feed description (default)',
			  `eligibilityOptions` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Eligibility options (one per line; first will be the default)',
			  `feedDescriptionType` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '%s events' COMMENT 'Feed description (category = %s)',
			  `feedCssPrefix` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'eventsfeed' COMMENT 'CSS prefix for JS feed classes/IDs',
			  `headerLogo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Header logo (if any)',
