	...
	public function databaseStructure ()
	{
		return "
			...
			CREATE TABLE IF NOT EXISTS `{$this->settings['table']}` (
			  ...
			  PRIMARY KEY (`eventId`)
			) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Events';
			...
			) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='List of event types';
		";
	}
